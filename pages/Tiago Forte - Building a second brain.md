...
1. Choose your notes app
1. Choose a capture tool
1. Get set up with PARA
1. Get inspired by identifying your twelve favorite problems
1. Automatically capture your ebook highlights
  ...
  What do you most want to capture, learn, explore, or share? Identify two to three kinds of content that you already value to get started with.
	...
	- make a list of some of your favorite problems, save the list as a note, and revisit it any time you need ideas for what to capture
	  1. Practice Progressive Summarization
	  1. Experiment with just one Intermediate Packet
	  1. Make progress on one deliverable
	...
	- Dial Down the Scope
	  ...
	  1. Assess your notetaking proficiency
